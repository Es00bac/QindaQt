...
QList<QindaQt::AppShell::ActionSpec> editorActionCatalog() {
  ...
  QList<ActionSpec> actions{
      ...
      spec(AppShellActionIds::FilePrint, "file", "File", "Print…",
           "Print the active document as plain text in its document font",
           QKeySequence::Print, 0, 5, false),
      spec(AppShellActionIds::FilePrintPreview, "file", "File",
           "Print Preview…",
           "Preview the active document's printed pages", key("Ctrl+Shift+P"),
           0, 6, false),
      spec(AppShellActionIds::FileQuit, "file", "File", "Quit",
           "Close this window after document dirty consent",
           QKeySequence::Quit, 0, 7),
