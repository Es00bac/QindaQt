...
public:
  ...
  //   mode visible, with hold taking priority when both are supplied, unless
  //   an active fullscreen or non-maximized window covers the entire output;
  ...
  // An active fullscreen or non-maximized output-covering window hides every
  // mode except Never before reveal/hold evaluation, so a stale edge lease
  // cannot overlay fullscreen while ordinary maximized clients remain revealable.
