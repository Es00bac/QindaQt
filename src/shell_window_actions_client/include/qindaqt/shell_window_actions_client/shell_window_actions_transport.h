...
public:
    ...
    virtual void requestIdentity(quint64 token,
...
Q_SIGNALS:
    ...
    void identityInvalidated(const QString &uniqueOwner);
    void identityReplyReceived(quint64 token, const QString &uniqueOwner,
                               const QByteArray &payload);
    void identityRequestFailed(quint64 token, const QString &uniqueOwner,
                               const QString &message);
};
