...
- Worktree: `/home/cabewse/work_SPaC3/container-wm-workers/bluetooth-settings-route`.
- Product authority: `src/apps/settings/bluetooth/**`, `tests/apps/settings/bluetooth/**`, `docs/wiki/apps/bluetooth-settings.md`, additive Settings Center/build/test/docs registrations, this record, and `ops/team/messages/first-party-settings/**`.
