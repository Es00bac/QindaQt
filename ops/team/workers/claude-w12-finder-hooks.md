...
- Status: working — FileManager1 D-Bus service, desktop menus through the File Manager catalog and boundary, Keep in Dock.
- Exact base: `f7c305f1` (round/code-first-20260924).
