...
file(COPY "${module_root}/" DESTINATION "${stage}/src/services/display_color_discovery")
...
file(GLOB staged_sources LIST_DIRECTORIES false "${stage}/src/services/display_color_discovery/src/*.cpp")
...
message(STATUS "Display color boundary policy correctly rejects planted forbidden dependencies")
file(REMOVE_RECURSE "${stage}")
