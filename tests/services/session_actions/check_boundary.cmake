...
foreach(root IN LISTS consumer_roots)
    ...
    foreach(file IN LISTS files)
        ...
        if(contents MATCHES "org\\.freedesktop\\.login1|/org/freedesktop/login1|CanPowerOff|CanReboot|CanSuspend")
            message(FATAL_ERROR
                "Direct login1 authority escaped session_actions: ${file}")
        endif()
    endforeach()
endforeach()
