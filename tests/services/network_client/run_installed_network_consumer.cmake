...
foreach(required IN ITEMS QINDAQT_CMAKE QINDAQT_BUILD_DIRECTORY QINDAQT_INSTALL_PREFIX
                          ...
                          QINDAQT_NETWORK_PROTOCOL_LIBRARY_NAME
                          QINDAQT_NETWORK_MODEL_LIBRARY_NAME
                          QINDAQT_NETWORK_CLIENT_LIBRARY_NAME QINDAQT_QT6_DIR)
...
execute_process(
    COMMAND
        ...
        "-DQINDAQT_NETWORK_PROTOCOL_LIBRARY=${install_prefix}/${QINDAQT_INSTALL_LIBDIR}/${QINDAQT_NETWORK_PROTOCOL_LIBRARY_NAME}"
        "-DQINDAQT_NETWORK_MODEL_LIBRARY=${install_prefix}/${QINDAQT_INSTALL_LIBDIR}/${QINDAQT_NETWORK_MODEL_LIBRARY_NAME}"
        "-DQINDAQT_NETWORK_CLIENT_LIBRARY=${install_prefix}/${QINDAQT_INSTALL_LIBDIR}/${QINDAQT_NETWORK_CLIENT_LIBRARY_NAME}"
...
set(consumer "${consumer_build}/qindaqt_installed_network_consumer")
execute_process(
    COMMAND "${consumer}"
...
if(NOT consumer_status EQUAL 0)
    message(FATAL_ERROR
        "Installed Network N0 consumer exited ${consumer_status}:\n"
