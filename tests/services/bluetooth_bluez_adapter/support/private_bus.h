...
// Private dbus-daemon fixture. Every BlueZ adapter row runs against this
// isolated bus carrying a fake org.bluez; no test contacts the host session
// or system bus, BlueZ, rfkill, or radios.
...
public:
    bool start()
    {
        ...
        name = QStringLiteral("qindaqt-bluez-adapter-test-%1")
