...
foreach(required IN ITEMS BUILD_DIRECTORY INSTALL_PREFIX INSTALL_BINDIR
    ...
    if(NOT DEFINED ${required})
        message(FATAL_ERROR "missing installed Default Applications route input: ${required}")
    endif()
endforeach()
...
if(NOT in_build OR install_prefix STREQUAL build_directory)
    message(FATAL_ERROR "Default Applications route stage must remain below its build tree")
endif()
...
if(NOT install_status EQUAL 0)
    message(FATAL_ERROR "Default Applications route install failed:\n${install_output}${install_error}")
endif()

set(executable "${install_prefix}/${INSTALL_BINDIR}/${SETTINGS_EXECUTABLE_NAME}")
set(module "${install_prefix}/${INSTALL_QMLDIR}/QindaQt/SettingsApp/DefaultApplications")
...
foreach(required_path IN ITEMS "${executable}" "${module}" "${theme_directory}")
    if(NOT EXISTS "${required_path}")
        message(FATAL_ERROR "installed Default Applications route payload missing: ${required_path}")
    endif()
endforeach()
set(sandbox "${install_prefix}/default-apps-route-runtime")
...
if(NOT route_status MATCHES "[Tt]imeout")
    message(FATAL_ERROR
        "relocated Default Applications route did not remain constructed (${route_status}):\n${route_status_log}")
endif()
message(STATUS "Relocated Default Applications Settings route remained resident with host buses poisoned")
