...
inline QVariantList makeInputDevices()
{
    return {
        ...
        QVariantMap{
            ...
            {QStringLiteral("kindText"), QStringLiteral("Input device")},
            {QStringLiteral("displayName"), QStringLiteral("USB Microphone")},
            {QStringLiteral("volumePercent"), 60},
            {QStringLiteral("volumeKnown"), true},
            {QStringLiteral("muted"), false},
            {QStringLiteral("muteKnown"), true},
            {QStringLiteral("isDefault"), false},
            ...
            {QStringLiteral("muteAvailable"), true},
            {QStringLiteral("channelVolumes"),
             channelRows({QStringLiteral("FL"), QStringLiteral("FR")}, 60)},
            {QStringLiteral("channelVolumeAvailable"), true},
            {QStringLiteral("virtualDevice"), false},
            {QStringLiteral("stateText"), QStringLiteral("Volume 60%")},
        },
    };
}
...
inline QVariantList makeStreams()
{
    return {
        QVariantMap{
            ...
            {QStringLiteral("targetSerial"), qulonglong(10)},
            {QStringLiteral("targetKindText"), QStringLiteral("Output device")},
            {QStringLiteral("targetChoices"),
            ...
            {QStringLiteral("moveAvailable"), true},
            {QStringLiteral("volumePercent"), 75},
            {QStringLiteral("volumeKnown"), true},
            {QStringLiteral("muted"), false},
            {QStringLiteral("muteKnown"), true},
        ...
        QVariantMap{
            ...
            {QStringLiteral("targetName"),
             QStringLiteral("Desk Microphone")},
            {QStringLiteral("targetSerial"), qulonglong(20)},
            {QStringLiteral("targetKindText"), QStringLiteral("Input device")},
            {QStringLiteral("targetChoices"),
             QVariantList{QVariantMap{{QStringLiteral("serial"), qulonglong(20)},
                                      {QStringLiteral("label"), QStringLiteral("Desk Microphone")}},
                          QVariantMap{{QStringLiteral("serial"), qulonglong(22)},
                                      {QStringLiteral("label"), QStringLiteral("USB Microphone")}}}},
            {QStringLiteral("moveAvailable"), true},
