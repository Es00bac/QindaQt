...
foreach(required IN ITEMS BUILD_DIRECTORY INSTALL_PREFIX INSTALL_BINDIR
    ...
    if(NOT DEFINED ${required})
        message(FATAL_ERROR "missing installed About Computer route input: ${required}")
    endif()
endforeach()
...
if(NOT in_build OR install_prefix STREQUAL build_directory)
    message(FATAL_ERROR "About Computer route stage must remain below its build tree")
endif()
...
if(NOT install_status EQUAL 0)
    message(FATAL_ERROR "About Computer route install failed:\n${install_output}${install_error}")
endif()

set(executable "${install_prefix}/${INSTALL_BINDIR}/${SETTINGS_EXECUTABLE_NAME}")
set(module "${install_prefix}/${INSTALL_QMLDIR}/QindaQt/SettingsApp/AboutComputer")
...
foreach(required_path IN ITEMS "${executable}" "${module}" "${theme_directory}")
    if(NOT EXISTS "${required_path}")
        message(FATAL_ERROR "installed About Computer route payload missing: ${required_path}")
    endif()
endforeach()
set(sandbox "${install_prefix}/about-computer-route-runtime")
...
function(run_route result_name)
    execute_process(
        COMMAND "${CMAKE_COMMAND}" -E env
                ...
                "${executable}" --page about-computer
...
if(NOT route_status MATCHES "[Tt]imeout")
    message(FATAL_ERROR
        "relocated About Computer route did not remain constructed (${route_status}):\n${route_status_log}")
endif()
message(STATUS "Relocated About Computer Settings route remained resident with host buses poisoned")
