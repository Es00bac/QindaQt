...
| Platform services | Audio, power, brightness, Bluetooth, network, clipboard, display/color/font settings, portals and policy | In progress (Audio1 and Display D0-D2 execute; PB-0, Clipboard C0, and Font F0 pure foundations are WIRED; live font discovery/application, clipboard capture/service/UI, Display client/writer/UI, resident Power service/client/upstream adapters, hardware qualification, and other providers remain) |
