...
| [ADR-0030](0030-confine-qtermwidget-behind-terminal-adapter.md) | Accepted | Confine the qtermwidget6 VT/rendering dependency behind the Terminal rendering adapter |
