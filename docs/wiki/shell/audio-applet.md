...
| `qindaqt.audio-applet-wheel` | Real popup-window wheel delivery for stream/device accumulation, pixel-only input, zero/horizontal/modifier admission, pending coalescing, bounds, and disabled no-mutation. |
