...
([ADR-0203](../adr/0203-an-ordinary-window-rolls-up-to-its-icon.md)) can roll
...
| `iconifiedWindowCount` | JSON integer | Independent windows currently rolled up to their icon chips ([ADR-0203](../adr/0203-an-ordinary-window-rolls-up-to-its-icon.md)) |
