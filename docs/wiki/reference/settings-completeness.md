...
| 15 | `windows` | [Focus, docking modifier, snap distance and close-container policy](../apps/windows-settings.md) | Session/KWin bridge applies four keys; `sessionRestore` remains reserved and hidden. |
