...
| 5 | `customize` | [Layout presets: switch, save, rename, duplicate, delete, restore; panel auto-hide delay](../apps/customize-settings.md) | Layouts are edited on the panels, not here (ADR-0267); Customize edits panel reveal/hide timing through the shell visibility policy; the customization chord still lacks a verified editor. |
