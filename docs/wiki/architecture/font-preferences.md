...
or links fontconfig (ADR-0067). It also hosts the F1 production composition
...
- [ADR-0067: Confine fontconfig behind the Font F1 discovery provider](../adr/0067-confine-fontconfig-behind-font-discovery.md)
