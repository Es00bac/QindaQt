...
| `src/shell` | Qt Quick presentation, production panel-window factory, and shell controllers consuming public values | `core`, `profiles`, `themes`, `shell_layout`, `shell_orchestration`, `shell_surface`, and public service clients; never LayerShellQt directly |
