...
| fontconfig | 2.x development headers, used only by the font discovery provider ([ADR-0057](docs/wiki/adr/0057-confine-fontconfig-behind-font-discovery.md)) | `fontconfig 2.17.1-1` |
...
sudo pacman -S --needed \
  ...
  layer-shell-qt dbus fontconfig xorg-xdpyinfo xorg-xwayland
```
